...
const AdminSignup = () => {
  ...
  return (
    <>
      <div className="flex justify-center w-full h-screen bg-[#9364b4]">
        <div className="w-96 h-[388px] p-6 shadow-lg bg-white rounded-md my-32">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div>
              <button
                type="submit"
                className="border-2 border-[#9364b4] bg-[#9364b4] text-white py-1 w-full rounded-md mt-5 hover:bg-transparent hover:text-[#9364b4] font-semibold"
              >
                Register
              </button>
            </div>
            <div className="m-4 text-center">
              <p className="">
                ...
                <Link
                  className="text-[#783da3] text-[20px] ml-1"
                  to="/adminlogin"
                >
                  Login
                </Link>
